...
This is an algorithm-based team project in C Programming Language as submitted by **Pomaa Ewurah-Abena Oppong** and **Dorothy Dede Quao** for the **ALX** Software Engineering Program.
The sorting algorithms implements multiple algorithm methods that are linked to their corresponding Big O notations. Find project summary details below:
